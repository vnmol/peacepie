...
десятка библиотек из удаленных репозиториев, что занимает некоторое время. Дождитесь пока в окне терминала 
не появиться сообщение от утилиты **pip**: "Successfully installed lib1, lib2, ...".
...
С команды "exit" и начнем ознакомление. Получатель можем быть любым, поскольку команда "exit"
...
После выполнения команды система завершит работу. Запустим вновь скрипт и выполним команду
